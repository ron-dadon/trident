<?php
/**
 * This is the debug class template. You can change the html as needed. This template assumes jQuery and Bootstrap are
 * present.
 */
?>
<div class="container">
    <div class="panel panel-default" style="direction: ltr">
        <div class="panel-heading">
            ...
            <span class="pull-right" style="cursor: pointer"><a
                    onclick="$('#debug-body').fadeToggle()">Toggle</a></span>
        </div>
